...
ACLOCAL = ${SHELL} /data/intranet/software/rpconfig/json-c-0.11/missing --run aclocal-1.11
AMTAR = ${SHELL} /data/intranet/software/rpconfig/json-c-0.11/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /data/intranet/software/rpconfig/json-c-0.11/missing --run autoconf
AUTOHEADER = ${SHELL} /data/intranet/software/rpconfig/json-c-0.11/missing --run autoheader
AUTOMAKE = ${SHELL} /data/intranet/software/rpconfig/json-c-0.11/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /data/intranet/software/rpconfig/json-c-0.11/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
STRIP = strip
VERSION = 0.11
abs_builddir = /data/intranet/software/rpconfig/json-c-0.11
abs_srcdir = /data/intranet/software/rpconfig/json-c-0.11
abs_top_builddir = /data/intranet/software/rpconfig/json-c-0.11
abs_top_srcdir = /data/intranet/software/rpconfig/json-c-0.11
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /data/intranet/software/rpconfig/json-c-0.11/install-sh
