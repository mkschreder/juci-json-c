...
ACLOCAL = ${SHELL} /tmp/juci-feed/json-c/missing --run aclocal-1.11
AMTAR = ${SHELL} /tmp/juci-feed/json-c/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /tmp/juci-feed/json-c/missing --run autoconf
AUTOHEADER = ${SHELL} /tmp/juci-feed/json-c/missing --run autoheader
AUTOMAKE = ${SHELL} /tmp/juci-feed/json-c/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /tmp/juci-feed/json-c/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
STRIP = strip
VERSION = 0.11
abs_builddir = /tmp/juci-feed/json-c
abs_srcdir = /tmp/juci-feed/json-c
abs_top_builddir = /tmp/juci-feed/json-c
abs_top_srcdir = /tmp/juci-feed/json-c
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /tmp/juci-feed/json-c/install-sh
